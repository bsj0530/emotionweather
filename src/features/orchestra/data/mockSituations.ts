...
export const MOCK_SITUATIONS: SituationCard[] = [
  // ✅ 1. 물건 상황
  {
    ...
    imageUrl: item,
    sentences: {
      "emo-annoyed": "물건을 말 없이 가져가서 짜증났어요.",
      "emo-sad": "물건을 말 없이 가져가서 속상했어요.",
      "emo-angry": "물건을 말 없이 가져가서 화가 났어요.",
      "emo-surprised": "물건을 말 없이 가져가서 놀랐어요.",
      "emo-confused": "물건을 말 없이 가져가서 어이없었어요.",
      "emo-upset": "물건을 말없이 가져가서 기분 나빴어요.",
    },
  },
